  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 rounded-2xl flex items-center justify-center" style={{ background: '#3b82f622' }}>
          <ClipboardList size={24} style={{ color: '#3b82f6' }} />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-white">Procurement</h1>
          <p className="text-gray-400 text-sm">Purchase orders and vendor management</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-surface-elevated p-8 flex flex-col items-center justify-center gap-3 min-h-[300px]">
        <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: '#3b82f622' }}>
          <ClipboardList size={32} style={{ color: '#3b82f6' }} />
        </div>
        <h2 className="text-lg font-semibold text-white">Procurement Module</h2>
        <p className="text-gray-400 text-sm text-center max-w-sm">Purchase orders and vendor management. Start by adding your first record.</p>
        <button
