    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">Quality control checks and alerts</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-surface-elevated p-8 flex flex-col items-center justify-center gap-3 min-h-[300px]">
        <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: '#22c55e22' }}>
          <BadgeCheck size={32} style={{ color: '#22c55e' }} />
        </div>
        <h2 className="text-lg font-semibold text-white">Quality Module</h2>
        <p className="text-gray-400 text-sm text-center max-w-sm">Quality control checks and alerts. Start by adding your first record.</p>
        <button
