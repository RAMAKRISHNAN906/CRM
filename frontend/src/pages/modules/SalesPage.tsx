    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">Sales orders and revenue management</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-surface-elevated p-8 flex flex-col items-center justify-center gap-3 min-h-[300px]">
        ...
        <h2 className="text-lg font-semibold text-white">Sales Module</h2>
        <p className="text-gray-400 text-sm text-center max-w-sm">Sales orders and revenue management. Start by adding your first record.</p>
        <button
