    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 rounded-2xl flex items-center justify-center" style={{ background: '#8b5cf622' }}>
          <Users2 size={24} style={{ color: '#8b5cf6' }} />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-white">CRM</h1>
          <p className="text-gray-400 text-sm">Customer relationship management hub</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-surface-elevated p-8 flex flex-col items-center justify-center gap-3 min-h-[300px]">
        ...
        <h2 className="text-lg font-semibold text-white">CRM Module</h2>
        <p className="text-gray-400 text-sm text-center max-w-sm">Customer relationship management hub. Start by adding your first record.</p>
        <button
