  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 rounded-2xl flex items-center justify-center" style={{ background: '#f9731622' }}>
          <Mail size={24} style={{ color: '#f97316' }} />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-white">Email</h1>
          <p className="text-gray-400 text-sm">Email campaigns and tracking</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-surface-elevated p-8 flex flex-col items-center justify-center gap-3 min-h-[300px]">
        <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: '#f9731622' }}>
          <Mail size={32} style={{ color: '#f97316' }} />
        </div>
        <h2 className="text-lg font-semibold text-white">Email Module</h2>
        <p className="text-gray-400 text-sm text-center max-w-sm">Email campaigns and tracking. Start by adding your first record.</p>
        <button
