...
export declare const getLead: (req: Request, res: Response, next: NextFunction) => Promise<void>;
...
export declare const convertToOpportunity: (req: Request, res: Response, next: NextFunction) => Promise<void>;
