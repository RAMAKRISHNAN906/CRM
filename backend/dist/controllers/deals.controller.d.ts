...
export declare const getDeals: (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const getDeal: (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const createDeal: (req: Request, res: Response, next: NextFunction) => Promise<void>;
